...
# parser.add_argument('--use_pretrained', type=bool, default=False, help='use pretrain')
'''
# book
...
if __name__ == '__main__':
    ...
    # if os.path.exists('../data/movie/ratings_final.txt'):
    #     # print(res[:100])
    #     os.remove('../data/movie/ratings_final.txt')
    #
    # if os.path.exists('../data/movie/ratings_final.npy'):
    #     os.remove('../data/movie/ratings_final.npy')
    # print('deleted old ratings: status ok')
    # with open('../data/movie/ratings_final.txt', 'w') as f:
    #     for line in res:
